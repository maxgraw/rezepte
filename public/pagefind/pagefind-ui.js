(() => {
	...
	function me(n, e, t, s) {
		...
		r && r.m(e, t),
			s ||
				_t(() => {
					const i = n.$$.on_mount.map(ft).filter($e);
	...
	function nt(n, e = {}) {
		...
		if (
			...
			l = l ? l + 2 : 1;
			let a = l;
			while (r.charCodeAt(a) === 45 && Z(r.charCodeAt(a + 1))) {
				const o = l + 1;
...
`),
			...
			cn = async () => {
				while (!H) un(), await new Promise((g) => setTimeout(g, 50));
			},
			_s = async (g, F) => {
				t(16, (ln = g || "")),
